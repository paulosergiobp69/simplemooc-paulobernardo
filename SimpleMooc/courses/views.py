...
#    return HttpResponse('home page de cursos')


#  metodo utilizando o parametro numerico para saber no futuro
...
def details(request, slug):
    ...
    if request.method == 'POST':       
        ...
        if form.is_valid():
            ...
            form.envia_mail(course)
            #exemplo de depuracao no django - mostra todos os campos da tela
            #print(form.cleaned_data) 
            #exemplo de depuracao no django - mostra todos os campo a campo
...
def enrollment(request, slug):
    ...
    # so libera se alterar no model def activate(self): de 1 para 0
    if created:
    #    enrollment.active()
...
# Decorators: aula 66
# com a utilização do decorator todo o codigo
# abaixo da classe nao é mais necessaria
#
##    course = get_object_or_404(Course, slug=slug)
